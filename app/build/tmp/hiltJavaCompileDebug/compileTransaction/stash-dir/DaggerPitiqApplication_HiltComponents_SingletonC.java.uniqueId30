...
public final class DaggerPitiqApplication_HiltComponents_SingletonC {
  ...
  public static PitiqApplication_HiltComponents.SingletonC create() {
  ...
  private static final class ActivityCImpl extends PitiqApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.com_pitiq_app_session_SessionViewModel, SessionViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_pitiq_app_session_SessionViewModel = "com.pitiq.app.session.SessionViewModel";

      @KeepFieldType
      SessionViewModel com_pitiq_app_session_SessionViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends PitiqApplication_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(LazyClassKeyProvider.com_pitiq_app_session_SessionViewModel, ((Provider) sessionViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.pitiq.app.session.SessionViewModel 
